...
def extract_qa_from_text(file_path, category):
    """从文本文件中提取问答对"""
    questions = []
...
def main():
    ...
    # 处理编程学习问题
    programming_questions = extract_qa_from_text("programming_qa.txt", "programming")
    
    # 处理学习方法问题
    learning_questions = extract_qa_from_text("learning_qa.txt", "learning")
